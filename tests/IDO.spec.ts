            ...
            IDO.createFromConfig(
                {
                    ...
                    referrals: [
                        {
                            address: (await blockchain.treasury('sender1')).address,
                            referralID: 'sender1',
                            batch: 'gold',
                        },
                        {
                            address: (await blockchain.treasury('sender2')).address,
                            referralID: 'sender2',
                            batch: 'silver',
                        },
                        {
                            address: (await blockchain.treasury('sender3')).address,
                            referralID: 'sender3',
                            batch: 'bronze',
                        },
                        {
                            address: (await blockchain.treasury('sender4')).address,
                            referralID: 'sender4',
                            batch: 'inactiveBronze',
                        },
                    ],
