...
export const mimcHash = (items: any[]) => mimcsponge.multiHash(items.map((item) => BigInt(item))).toString();

export const mimcHash2 = (a: any, b: any) => mimcsponge.multiHash([BigInt(a), BigInt(b)]).toString();

export const mimcHash3 = (a: any, b: any, c: any) => mimcsponge.multiHash([BigInt(a), BigInt(b), BigInt(c)]).toString();
